...
CREATE TABLE prestadores (
  ...
  rescisao_multa_percentual DECIMAL(8,2) NOT NULL DEFAULT 0,
  rescisao_multa_empresa_percentual DECIMAL(8,2) NOT NULL DEFAULT 0,
  rescisao_multa_prestador_percentual DECIMAL(8,2) NOT NULL DEFAULT 0,
...
CREATE TABLE rescisoes (
  ...
  data_aviso DATE NULL,
  tipo_rescisao ENUM('empresa', 'prestador') NOT NULL DEFAULT 'empresa',
  aviso_dias INT NOT NULL DEFAULT 0,
  aviso_cumprido TINYINT(1) NOT NULL DEFAULT 0,
